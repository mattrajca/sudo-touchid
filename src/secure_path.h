...
int sudo_secure_dir __P((const char *path, uid_t uid, gid_t gid, struct stat *sbp));
int sudo_secure_file __P((const char *path, uid_t uid, gid_t gid, struct stat *sbp));
int sudo_secure_path __P((const char *path, int type, uid_t uid, gid_t gid, struct stat *sbp));
